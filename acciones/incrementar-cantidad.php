...
try {
    ...
    $_SESSION['mensaje_error'] = '<i class="bi bi-exclamation-square"></i> Ocurrió un error al intentar incrementar la cantidad. Por favor, intenta nuevamente en unos minutos.';
    header("Location: ../index.php?s=carrito");
    exit;
}